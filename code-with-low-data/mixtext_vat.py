...
class BertModel4Mix(BertPreTrainedModel):
    ...
    def forward(self, input_ids,  input_ids2=None, l=None, mix_layer=1000, attention_mask=None, token_type_ids=None, position_ids=None, head_mask=None, pre_embeddings=None):
        ...
        if input_ids2 is not None:
            ...
            # when input_ids2 is not present and pre_embeddings is not None, 
            if pre_embeddings is not None:   #------------------------------------------------
                
                embedding_output = pre_embeddings
...
class MixText(nn.Module):
    ...
    def forward(self, x, x2=None, l=None, mix_layer=1000, pre_embeddings=None):
        ...
        if x2 is not None:
            ...
            all_hidden, pooler = self.bert(x, pre_embeddings=pre_embeddings)
