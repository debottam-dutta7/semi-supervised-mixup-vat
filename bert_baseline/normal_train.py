...
parser.add_argument('--data-path', type=str, default='/home/debottamd/course_work/DL-NLP/Project/Dataset/yahoo_answers_csv/',
...
def main():
    ...
    for epoch in range(args.epochs):
        ...
        t1 = time.time()
        print("epoch {} took {:.2f} secs".format(epoch, t1-t0))
